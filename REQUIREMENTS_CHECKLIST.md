...
| Justification for RL | MDP formulation shows horizon 1 / no transitions → contextual bandit; supervised learning has no label source | `SCOPE.md#why-rl-and-specifically-a-contextual-bandit`, slides 2-3 of `presentation.md` |
...
| Alignment / safety reflection | Reward-hacking demo (bandit learns to idle under `-MAE` reward), fix via travel-deficit term; week-13 emergent-goal / goal-content-integrity framing; explicit acknowledgement of distribution shift risk | `scripts/run_alignment.py`, `results/alignment.png`, slide 6 of `presentation.md`, `presentation.md` Q&A (distribution shift), `SCOPE.md#things-i-consciously-did-not-build` (scope boundaries) |
| Literature grounding | Li et al. 2010 (LinUCB origin), Dogru et al. 2021 (RL-PID in control lit), Gal & Ghahramani 2016 (dropout as Bayesian approximation), Amodei et al. 2016 (Concrete Problems in AI Safety) | `README.md#key-literature`, slide 3 and slide 6 of `presentation.md` |

## Deliverable format

| item | location |
|---|---|
| Presentation (7 slides, speaker notes per slide) | [presentation.md](presentation.md) |
