...
|---|---|---|
| Applied use case in a structured domain | Beginner robotics education; adaptive PID tuning after chassis swaps | `SCOPE.md#the-use-case`, `README.md#why-a-bandit-not-ppo` |
...
| Alignment / safety reflection | Reward-hacking demo (bandit learns to idle under `-MAE` reward), fix via travel-deficit term; explicit acknowledgement of distribution shift risk | `scripts/run_alignment.py`, `results/alignment.png`, slide 5 of `presentation.md`, `SCOPE.md#things-i-consciously-did-not-build` |
...
| item | location |
|---|---|
| Presentation (6-7 slides, speaker notes per slide) | [presentation.md](presentation.md) |
